...
class MelodyGenerator:
    ...
    def __init__(self, model_path=r"C:\Users\LENOVO\OneDrive\Desktop\Internship-Project\model.h5"):
...
if __name__ == "__main__":
    ...
    melody = mg.generate_melody(seed, 500, SEQUENCE_LENGTH, 0.7) # Once the Melody is generated from this We have to convert this and save it in a media file  
    print(melody)
