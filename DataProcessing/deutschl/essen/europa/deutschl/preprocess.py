...
KERN_DATASET_PATH = r"C:\Users\LENOVO\OneDrive\Desktop\Internship-Project\DataProcessing\deutschl\essen\europa\deutschl\erk"
SAVE_DIR = r"C:\Users\LENOVO\OneDrive\Desktop\Internship-Project\DataProcessing\dataset"
SINGLE_FILE_DATASET = r"C:\Users\LENOVO\OneDrive\Desktop\Internship-Project\DataProcessing\filedataset\filedataset.txt"
...
def encode_song(song, time_step=0.25): # Now each dataset we are training we have to make its text file so that it can be noted In the text field we are converting it in the form of string 
